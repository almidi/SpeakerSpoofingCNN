...
class fdata(object):
    ...
    def format_data(self,data):
        ...
        wavfilenames = [x[:-4]+'.wav' for x in filenames]
        ...
        for filename in filenames :
            with open(fbank_dir + '/'+filename, 'r') as fid:
                ...
                #No comments...
                fmaps_attr_temp = [attr[1:] for attr in attrs if   attr[0] == wavfilenames[filenames.index(filename)] for k in fmaps_temp]
